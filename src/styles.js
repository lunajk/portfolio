const styles = {
  ...
  sectionHeadText:
    'text-eerieBlack font-black md:text-[44px] sm:text-[42px] xs:text-[34px] text-[28px] font-poppins',
  sectionHeadTextLight:
    'text-timberWolf font-black md:text-[40px] sm:text-[42px] xs:text-[30px] text-[20px] font-poppins',
  sectionSubText:
